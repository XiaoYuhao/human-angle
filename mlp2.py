...
def main(hidden_layers, hidden_size, batch_size, learning_rate):
    ...
    model = MultiLayerNet(input_size=9, hidden_size=hidden_size, output_size=16, layers=hidden_layers)
    ...
    epoch = 1000
    #batch_size = 1000
    train_dataset = Dataset('dataset/train.json')
    ...
    val_dataset = Dataset('dataset/test.json')
...
if __name__ == '__main__':
    ...
    main(hidden_layers=2, hidden_size=512, batch_size=1000, learning_rate=5e-4)
    #evaluate()